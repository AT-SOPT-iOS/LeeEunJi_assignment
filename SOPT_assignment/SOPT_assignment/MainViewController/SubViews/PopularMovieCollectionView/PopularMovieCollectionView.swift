...
final class PopularMovieCollectionView: UICollectionView, UICollectionViewDataSource {
    
    private var itemData = PopularMovieModel.dummy()
    ...
    private func register() {
        register(PopularMovieCollectionViewCell.self, forCellWithReuseIdentifier: PopularMovieCollectionViewCell.identifier)
    }
